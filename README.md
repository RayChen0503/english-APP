...
- 真實資料功能：已新增 SQLite 本機資料庫，保存 app 狀態與學習事件；本機帳號、學生管理與操作結果會持久保存。
- 真 AI 功能：已做到依題型變化的 AI 診斷、學生回饋、接力摘要模擬；尚未串接真 AI API。
- 老師/志工端：已做到學生列表、學生詳細、待辦逐項完成、志工回覆、接力優先序；尚未做多人即時協作。
- 學生端學習：已擴充多題型、任務契約、反思、復原任務、學習紀錄時間線；尚未接正式題庫。
- UI：已補更多狀態卡、流程頁、操作後回饋與時間線；尚未進入正式設計系統。
- 離線同步：已做到本機同步中心、待上傳計數、全部同步模擬；尚未做真下載與網路偵測。
